...
\begin{multicols}{3}
  \begin{flushleft}
    \color{gray}{\faPhone} \href{tel:915473659}{915 473 659} \\
    \color{gray}{\faEnvelope} \href{g.patatas22@gmail.com}{g.patatas22@gmail.com} \\
  \end{flushleft}
  
\columnbreak

  \begin{center}
      {\huge\bfseries Gonçalo Patatas} \par
      Lisboa, Portugal \par
  \end{center}
...
\uthree{Graduation University}{B.Sc. in Engineering}{August 2020}{
    ...
    \item Rover Resume Award, Rover Resume Award,Rover Resume Award
}
...
%===================%
\begin{enumerate}[label={[\texttt{\arabic*}]}, left=0pt .. 1.5em]
